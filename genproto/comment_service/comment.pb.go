...
func (m *GetCommentId) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GetCommentId)(nil), "comment.GetCommentId")
...
var fileDescriptor_55720040aaa933ee = []byte{
	...
	,
}
...
type CommentServiceClient interface {
	...
	GetCommentById(ctx context.Context, in *GetCommentId, opts ...grpc.CallOption) (*Comment, error)
...
func (c *commentServiceClient) GetCommentById(ctx context.Context, in *GetCommentId, opts ...grpc.CallOption) (*Comment, error) {
	out := new(Comment)
...
type CommentServiceServer interface {
	...
	GetCommentById(context.Context, *GetCommentId) (*Comment, error)
...
func (*UnimplementedCommentServiceServer) GetCommentById(ctx context.Context, req *GetCommentId) (*Comment, error) {
...
func _CommentService_GetCommentById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).GetCommentById(ctx, req.(*GetCommentId))
	}
	return interceptor(ctx, in, info, handler)
}
